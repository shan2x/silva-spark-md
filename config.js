...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "so4lkJgZ#ghYnK1fuTJI5WZnJCHFgOlmvf0euLoNhYLCRlWKtYcA",
// add your Session Id 
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "94729299089",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "✦SHAN✦",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*SHAN ✦ MD ✦*",
// add bot owner name    
